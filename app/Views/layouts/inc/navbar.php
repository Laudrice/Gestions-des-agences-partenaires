    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center h-16">
            ...
            <ul id="menu" class="hidden md:flex space-x-4">
                <li><a class="nav-link hover:bg-green-400 px-3 py-2 rounded text-white accueil" href="#">Accueil</a></li>
                <li><a class="nav-link hover:bg-green-400 px-3 py-2 rounded text-white employe" href="#">Agences</a></li>
