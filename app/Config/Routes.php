...
//Terroir
$routes->get('/contrats/listIntervention/(:any)', 'ContratController::listIntervention/$1');
$routes->get('/contrats/terroirOperation/(:any)', 'ContratController::terroirOperation/$1');
